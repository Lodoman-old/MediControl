...
export default function AppLayout({ children }: Props) {
  ...
  const navItems = (
    <>
      ...
      <Link
        to="/descargar"
        className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-primary-600 text-white text-sm font-semibold hover:bg-primary-700 transition-colors shadow-sm whitespace-nowrap"
      >
  ...
  const mobileNavItems = (
    <>
      ...
      <div className="px-4 py-2 text-xs font-semibold text-ink-400 uppercase tracking-wider bg-ink-50/50">App</div>
      <div className="px-4 py-3">
        <Link
          to="/descargar"
          onClick={() => setMobileMenuOpen(false)}
          className="flex items-center justify-center gap-2 w-full px-4 py-3 rounded-xl bg-primary-600 text-white font-semibold text-base hover:bg-primary-700 transition-colors shadow-lg shadow-primary-200"
        >
